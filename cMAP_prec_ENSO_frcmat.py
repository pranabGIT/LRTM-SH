...
#####################################
** takes in daily trmm prec anom corresponding to DJF of El Nino years (during TRMM period)
   and produces the composite DJF El Nino prec anom

I M P O R T A N T: the composite data is regridded to HadGEM2 grid
...
#floutP = 'CMAP_LaNina_compAnom.npz'
...
prtr75 = np.mean(prtr[:,:,icc75[0]],2)
prtr25 = np.mean(prtr[:,:,icc25[0]],2)
...
floutM = ('Proj_laninaONcmap_frc_mat_lag'+str(ilag)+'_DJF_'+str(yr1)+'_'+str(yr2-1)+'.mat')
